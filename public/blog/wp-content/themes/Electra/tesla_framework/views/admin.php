...
<form method="post" action="save_options">
  ...
  <div class="tt_top_bar">
    <div class="tt_top_links">
      <span>
        <a class="tt_documentation" target="_blank" href="http://teslathemes.com/documentation/"><?php _e("Documentation",THEME_NAME)?></a>
      </span>
      <span>
        <a class="tt_support" target="_blank" href="http://teslathemes.com/forums/"><?php _e("Support",THEME_NAME)?></a>
      </span>
      <span>
        <a class="tt_news" target="_blank" href="http://teslathemes.com/blog/"><?php _e("Latest News",THEME_NAME)?></a>
      </span>
    </div>
                  ...
                  foreach($box['input_fields'] as $input_field_name => $input) : //======INPUT FIELDS START=============
                    ...
                    if($input_nr % $inputs_count == 0 && !empty($box['repeater'])): ?>
                      ...
                      <div class="remove_container">
                        <a class="remove_option">&#10006;<b><?php _e('Remove',THEME_NAME) ?></b></a>
                      </div>
                    </section>
                    <?php endif;
